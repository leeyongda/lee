...
function initTable() {
    var table = $("#example").dataTable({
        //"iDisplayLength":10,
        "sAjaxSource": "http://localhost:8888/test",
        'bPaginate': true,
        "bDestory": true,
        "bRetrieve": true,
        "bFilter":false,
        ...
        "aoColumns": [
...

            {
                ...
                "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                    ...
                    "onclick='_editFun(\"" + oData.id + "\",\"" + oData.name + "\")'>编辑</a>&nbsp;&nbsp;")
...
function _deleteFun(id) {
  ...
  alert(id);
    $.ajax({
        url: "http://localhost:8888/del_tag",
        data: id,
        type: "post",
...
function _addFun() {
    ...
    $.ajax({
        url: "http://localhost:8888/add_tag",
        data: jsonData,
        type: "post",
        success: function (backdata) {
            if (backdata) {
...
function _editFunAjax() {
    ...
    $.ajax({
        type: 'POST',
        url: 'http://localhost:8888/update_tag',
        data: jsonData,
